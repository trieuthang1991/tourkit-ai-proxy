...
![Mở trang AI phân tích Cơ hội](../images/uu-tien-deal-buoc1.png)
...
![Danh sách cơ hội](../images/uu-tien-deal-buoc2.png)
...
![Xác nhận chấm điểm hàng loạt](../images/uu-tien-deal-buoc4.png)
...
![Đang chấm điểm hàng loạt](../images/uu-tien-deal-buoc5.png)
...
![Chi tiết 1 cơ hội](../images/uu-tien-deal-buoc6.png)
...
![Bộ lọc nhanh](../images/uu-tien-deal-buoc8.png)
...
![Bộ lọc nâng cao](../images/uu-tien-deal-buoc9.png)
...
### Bước 11 — Mở cơ hội bên CRM để thao tác tiếp

Trang này chỉ giúp bạn phân tích và ưu tiên; khi cần cập nhật, chăm sóc, đổi trạng thái... thì thao tác đó nằm bên CRM TourKit. Có 2 lối tắt để nhảy thẳng sang, đều **mở ra tab (thẻ) mới** nên vẫn giữ nguyên màn hình AI đang xem:

- **Mở cả danh sách:** bấm nút **"Danh sách Cơ hội CRM"** ở góc trên bên phải trang — mở thẳng trang Cơ hội bán hàng trên CRM.
- **Mở đúng deal đang xem:** khi đã mở khung chi tiết một deal, bấm nút **"Xem cơ hội CRM"** ở cuối khung — CRM sẽ mở đúng cơ hội đó để bạn thao tác ngay.

![Nút mở cơ hội trên CRM](../images/uu-tien-deal-buoc11.png)
> 📸 Cần chụp: nút "Danh sách Cơ hội CRM" ở góc trên trang + nút "Xem cơ hội CRM" trong khung chi tiết deal.
...
- **Nút "Danh sách Cơ hội CRM" / "Xem cơ hội CRM" chỉ hiện khi bạn đã đăng nhập** — vì hệ thống dựa vào tài khoản đang đăng nhập để mở đúng CRM của công ty bạn. Nút mở CRM trong tab mới; nếu trình duyệt chặn cửa sổ bật lên (pop-up), hãy cho phép mở tab từ trang này.
...
**Q: Làm sao mở đúng deal này bên CRM để cập nhật/chăm sóc tiếp?**
A: Bấm vào dòng deal để mở khung chi tiết bên phải, rồi bấm nút **"Xem cơ hội CRM"** ở cuối khung — CRM TourKit sẽ mở đúng cơ hội đó trong một tab mới. Nếu chỉ muốn xem cả danh sách cơ hội bên CRM, bấm **"Danh sách Cơ hội CRM"** ở góc trên bên phải trang.
