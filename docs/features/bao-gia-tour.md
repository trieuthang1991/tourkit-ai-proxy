...
![Trang danh sách Tính giá Tour](../images/bao-gia-tour-buoc1.png)
...
![Thanh 4 bước của trình tạo báo giá](../images/bao-gia-tour-buoc2.png)
...
**Chọn "Nguồn giá tham khảo cho AI".** Ngay dưới phần chọn hạng khách sạn có một ô nhỏ tên **"Nguồn giá tham khảo cho AI"** với 3 lựa chọn — đây là chỗ bạn nói cho AI biết nó nên dựa vào bảng giá nào để dựng giá **sát thực tế thay vì bịa số**:

- **Cả 2 (ưu tiên NCC thật)** — *mặc định, khuyên dùng*. AI ưu tiên dùng bảng giá nhà cung cấp (NCC) thật của công ty; loại dịch vụ nào công ty chưa có giá thì lấy giá mẫu của hệ thống bù vào cho đủ.
- **Chỉ NCC thật** — chỉ dùng giá nhà cung cấp thật của công ty (những giá đã được đồng bộ về hệ thống).
- **Chỉ NCC mẫu** — chỉ dùng bộ giá mẫu tham khảo có sẵn của hệ thống. Phù hợp với công ty mới, dữ liệu giá thật còn ít.

Sau khi bấm sinh tour, ngay dưới ô này sẽ hiện một dòng xác nhận cho biết AI vừa dùng bao nhiêu mốc giá, ví dụ: *"✓ Lần sinh gần nhất: nạp 12 mốc giá (9 thật · 3 mẫu)"* — giúp bạn biết AI thực sự có dựa vào bảng giá hay không.

![Form nhập yêu cầu khách hàng](../images/bao-gia-tour-buoc3.png)
...
**Xem nhanh đơn giá theo đầu người.** Dưới mỗi con số **"COSTING (NET)"** của từng hoạt động giờ có thêm một dòng nhỏ cho biết AI ước theo đầu người thế nào, để bạn nhìn phát biết ngay mức giá/người có hợp lý không:

- Với chi phí tính theo từng khách (khách sạn, ăn uống, vé tham quan): dòng hiện *"≈ {đơn giá}/khách × {số khách}"*. Ví dụ bữa trưa tổng 34.400.000đ cho đoàn 215 khách sẽ hiện *"≈ 160.000đ/khách × 215 khách"*.
- Với chi phí dùng chung cả đoàn (vé máy bay, xe vận chuyển, hướng dẫn viên): dòng hiện *"chia {số khách} khách ≈ {bình quân}/khách"*. Ví dụ vé máy bay tổng 924.500.000đ cho đoàn 215 khách sẽ hiện *"chia 215 khách ≈ 4.300.000đ/khách"*.

![Chỉnh sửa lịch trình theo ngày](../images/bao-gia-tour-buoc5.png)
...
![Bảng tính giá và thanh điều khiển lợi nhuận](../images/bao-gia-tour-buoc6.png)
...
## 3B. Bảng giá nhà cung cấp lấy ở đâu ra?

Để AI dựng lịch trình bằng **giá thật** (Bước 4 ở trên) và để bạn chọn được **nhà cung cấp thực tế** khi sửa từng hoạt động (Bước 5), trước tiên bảng giá của khách sạn, nhà hàng, xe, vé… phải có sẵn trong hệ thống. Công ty chưa nhập bảng giá nào thì AI chỉ còn cách dựa vào giá mẫu chung, và số sẽ lệch xa thực tế hơn.

Bạn không phải gõ tay từng dòng giá: chỉ cần tải file báo giá nhà cung cấp lên, AI sẽ tự bóc thành bảng để bạn xem lại và lưu. Cách làm chi tiết xem ở [Hướng dẫn Nhà cung cấp](nhap-gia-ncc.md).
...
- **Giá AI dựng là ước lượng dựa trên bảng giá NCC, không phải giá chốt.** AI bám theo mốc giá tham khảo (thật của công ty và/hoặc mẫu hệ thống) để tránh bịa số, nhưng vẫn có thể lệch so với giá thực tế tại thời điểm bán. Luôn rà lại, nhất là các mục lớn như vé máy bay và vận chuyển.
- **Muốn AI dùng giá thật đầy đủ, hãy đồng bộ bảng giá NCC.** Nếu công ty chưa từng đồng bộ, AI sẽ nghiêng nhiều về giá mẫu của hệ thống. Bật tác vụ **"Đồng bộ bảng giá nhà cung cấp"** ở trang **Tự động hóa** (xem [Hướng dẫn Tự động hóa](tu-dong-hoa.md)) để bảng giá thật luôn được cập nhật.
- **Dòng đơn giá theo đầu người chỉ hiện khi hoạt động đã có mức giá.** Hoạt động chưa nhập giá (bằng 0) sẽ không có dòng ước tính này.
- **Chưa có bảng giá nhà cung cấp trong hệ thống thì AI chỉ dựng được giá mẫu.** Cách nhập bảng giá bằng AI, giới hạn định dạng file và những chỗ dễ vấp — xem [Hướng dẫn Nhà cung cấp](nhap-gia-ncc.md).
...
**Q: Giá AI đưa ra có chính xác không?**
A: Đây là **giá ước lượng để tham khảo**, không phải giá chốt. AI dựa vào bảng giá nhà cung cấp (thật của công ty và/hoặc mẫu hệ thống) để dựng số cho sát thực tế thay vì bịa, nhưng bạn vẫn nên rà lại — nhất là các mục lớn như vé máy bay, vận chuyển — trước khi gửi khách. Dòng "≈ .../khách" dưới mỗi hoạt động giúp bạn kiểm tra nhanh mức giá/người có hợp lý không.

**Q: "Nguồn NCC mẫu" ở ô chọn nguồn giá là gì?**
A: Là bộ giá mẫu tham khảo có sẵn của hệ thống, không phải giá thật của riêng công ty bạn. Nó hữu ích khi công ty còn mới hoặc chưa đồng bộ nhiều bảng giá thật — AI vẫn có mốc để dựng giá thay vì đoán mò. Khi công ty đã có nhiều giá thật, bạn nên để nguồn mặc định "Cả 2 (ưu tiên NCC thật)" hoặc "Chỉ NCC thật".

**Q: Vì sao nên bật đồng bộ bảng giá NCC?**
A: Để AI dựng giá bằng số thật của công ty (kể cả vé máy bay, vận chuyển, hướng dẫn viên) thay vì giá mẫu chung chung. Tác vụ **"Đồng bộ bảng giá nhà cung cấp"** ở trang **Tự động hóa** sẽ tự kéo bảng giá NCC mới về đều đặn — bạn cấu hình một lần, khỏi làm thủ công. Xem [Hướng dẫn Tự động hóa](tu-dong-hoa.md).

**Q: Dòng "≈ .../khách" hay "chia ... khách" dưới mỗi hoạt động có ý nghĩa gì?**
A: Đó là cách AI ước chi phí theo đầu người. Với chi phí tính theo từng khách (khách sạn, ăn uống, vé) sẽ hiện "≈ đơn giá/khách × số khách"; với chi phí dùng chung cả đoàn (vé máy bay, xe) sẽ hiện "chia số khách ≈ bình quân/khách". Đây chỉ là thông tin để bạn nhìn nhanh, không phải một khoản tính thêm.

**Q: Tôi nhập bảng giá của nhà cung cấp vào hệ thống bằng cách nào?**
A: Tải file báo giá lên trang **"AI Import NCC"**, AI sẽ tự bóc thành bảng để bạn xem lại rồi lưu. Toàn bộ hướng dẫn (kể cả cách tra cứu, lọc và xem nhanh bảng giá đã lưu) nằm ở [Hướng dẫn Nhà cung cấp](nhap-gia-ncc.md).

## 6. Ảnh cần bổ sung cho các phần mới

Các ảnh nên chụp thêm để minh họa những tính năng vừa cập nhật:

- **Ô "Nguồn giá tham khảo cho AI"** (Bước 3): chụp cận cảnh ô chọn nguồn giá với 3 nút "Cả 2 (ưu tiên NCC thật)" / "Chỉ NCC thật" / "Chỉ NCC mẫu", đang chọn mặc định "Cả 2", kèm dòng xác nhận "✓ Lần sinh gần nhất: nạp N mốc giá (x thật · y mẫu)" hiện bên dưới.
- **Dòng đơn giá theo đầu người** (Bước 5): chụp một hoạt động có chi phí theo khách (ví dụ bữa ăn hoặc khách sạn) hiện dòng "≈ .../khách × N khách", và một hoạt động chi phí chung (ví dụ vé máy bay/xe) hiện dòng "chia N khách ≈ .../khách" — lý tưởng chụp cả hai kiểu trong cùng một khung để so sánh.
