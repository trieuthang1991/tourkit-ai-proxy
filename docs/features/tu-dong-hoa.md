...
- **Tài khoản tự động nên có quyền xem toàn bộ dữ liệu công ty.** Nếu tài khoản chỉ thấy dữ liệu của riêng nó, tác vụ tự động cũng chỉ xử lý được bấy nhiêu, bỏ sót phần còn lại.
