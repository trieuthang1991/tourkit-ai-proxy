...
- **Trang chính sách và điều khoản nay có thông tin công ty, và bấm được từ chân trang.** Hai
  ...
  điện thoại, mã số thuế — thứ Facebook cần thấy khi xét duyệt hồ sơ doanh nghiệp. Nhân đó sửa
  luôn địa chỉ Hà Nội ở chân trang: đang ghi *Tầng 4, Tòa nhà 242…* trong khi giấy đăng ký kinh
  doanh là *Tầng 3, Số nhà 242…*.
